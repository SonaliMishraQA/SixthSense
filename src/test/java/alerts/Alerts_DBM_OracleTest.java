...
public class Alerts_DBM_OracleTest extends BaseClass {
...
//		alertsPage.selectApplicationfromDropdown("Oracle > oracle_V4.1.3_Patch");
	...
	public void TC_02_configure_Alerts_For_DBM_Oracle_Appication(String name,String metric,String aggregator,String operator,String thresholdValue,String timePeriod,String silencePeriod,String recoveryPeriod,String notificationChannel) throws EncryptedDocumentException, IOException
	{	
		String alertName="Oracle "+name; 
		// add alerts to the DBM oracle Application
	...
	{
		return eutil.fetchAllTheDataFromExcelSheet(IPathConstant.alertsExcelPath,IPathConstant.alertsOracleSheet);
	}
