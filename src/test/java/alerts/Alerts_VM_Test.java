...
public class Alerts_VM_Test extends BaseClass {
	...
	public void TC_01_pre_Request_For_Alerts_Configuration()
	{
		...
		alertsPage.selectCapabilityFromDropDown(IPathConstant.alertsVMCapability);
	...
	public void TC_02_configure_Alerts_For_VM_Lunix_Appication(String name,String metric,String aggregator,String operator,String thresholdValue,String timePeriod,String silencePeriod,String recoveryPeriod,String notificationChannel) throws EncryptedDocumentException, IOException
	{	
		String alertName="Lunix "+name; 
		// add alerts to the VM Lunix Application
	...
	{
		return eutil.fetchAllTheDataFromExcelSheet(IPathConstant.alertsExcelPath,IPathConstant.alertsVmSheet);
	}
