...
public class Alerts_DBM_MysqlTest extends BaseClass {
	...
	public void TC_02_configure_Alerts_For_DBM_Mysql_Appication(String name,String metric,String aggregator,String operator,String thresholdValue,String timePeriod,String silencePeriod,String recoveryPeriod,String notificationChannel) throws EncryptedDocumentException, IOException
	{	
		String alertName="MySql "+name; 
		// add alerts to the DBM mysql Application
	...
	{
		return eutil.fetchAllTheDataFromExcelSheet(IPathConstant.alertsExcelPath,IPathConstant.alertsMysqlSheet);
	}
