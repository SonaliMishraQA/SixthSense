...
public class Alerts_MM_Android_IOSTest extends BaseClass {
	...
	public void TC_01_pre_Request_For_Alerts_Configuration()
	{
		...
		alertsPage.selectCapabilityFromDropDown(IPathConstant.alertsMMCapability);
	...
	public void TC_02_configure_Alerts_For_MM_Android_Appication(String name,String metric,String aggregator,String operator,String thresholdValue,String timePeriod,String silencePeriod,String recoveryPeriod,String notificationChannel) throws EncryptedDocumentException, IOException
	{	
	
		String alertName="Android "+name; 
		
		// add alerts to the MM Android Application
	...
	public void TC_02s_configure_Alerts_For_MM_Ios_Appication(String name,String metric,String aggregator,String operator,String thresholdValue,String timePeriod,String silencePeriod,String recoveryPeriod,String notificationChannel) throws EncryptedDocumentException, IOException
	{	
		
		String alertName="IOS "+name; 
		// add alerts to the MM Ios Application
		alertsPage.addAlerts( alertName, metric, aggregator, operator, thresholdValue, timePeriod, silencePeriod, recoveryPeriod, notificationChannel,
							eutil.ReadDataFromExcelByUsingKeyProperty(IPathConstant.commExcelPath, IPathConstant.messageSheet, "AlertsAddedMessage"));
	}
	...
	{
		return eutil.fetchAllTheDataFromExcelSheet(IPathConstant.alertsExcelPath,IPathConstant.alertsMMSheet);
	}
